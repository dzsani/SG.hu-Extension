...
(function($) {
  ...
  $.cleditor.convertHTMLtoBBCode = function(html) {
    ...
    $.each([
		...
		[/<font class="Apple-style-span" color="#FFC0CB">([\s\S]*?)<\/font>/img, "[szin=pink]$1[/szin]"],
		[/<font class="Apple-style-span" color="#87CEEB">([\s\S]*?)<\/font>/img, "[szin=skyblue]$1[/szin]"],
  ...
  $.cleditor.convertBBCodeToHTML = function(code) {
	...
	$.each([
		...
		[/\[szin=pink\]([\s\S]*?)\[\/szin\]/gim, '<font class="Apple-style-span" color="#FFC0CB">$1</font>'],
		[/\[szin=skyblue\]([\s\S]*?)\[\/szin\]/gim, '<font class="Apple-style-span" color="#87CEEB">$1</font>'],
